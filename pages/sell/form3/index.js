...
Page({
    ...
    data: {
        ...
        location: [{ checked: false, id: "0", name: "买新车" }, { checked: false, id: "1", name: "买二手车" }, 
        { checked: false, id: "2", name: "不买车" }],
        nation: [{ checked: false, id: "0", name: "德系" }, { checked: false, id: "1", name: "日系" }, { checked: false, id: "2", name: "美系" }, 
        { checked: false, id: "3", name: "法系" }, { checked: false, id: "4", name: "韩系" }, { checked: false, id: "5", name: "国产" }],
    },
    max: function (e) {
